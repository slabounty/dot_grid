  ...
  class CLI
    def self.execute(argv)
      ...
      opts = Trollop::options argv do
        ...
        opt :page_types, "Types of pages desired: Types of pages desired: planner, checkerboard, grid, dot_grid, horizontal_rule, grid_plus_lines, dot_dash, line_printer", type: :string, default: "planner"
