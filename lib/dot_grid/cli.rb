  ...
  class CLI
    def self.execute(argv)
      ...
      opts = Trollop::options argv do
        ...
        opt :page_types, "Types of pages desired: Types of pages desired: DotGrid, Planner, Grid, HorizontalRule, Checkerboard, GridPlusLines", type: :string, default: "planner"
